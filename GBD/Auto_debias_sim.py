...
def para(args): 
    if args.dataset == 'simulation': 
        ...
        args.base_model_args = {'emb_dim': 128, 'learning_rate': 0.01, 'imputaion_lambda': 0.01, 'weight_decay': 1}
...
def train_and_eval(train_data, unif_train_data, val_data, test_data, device = torch.device("cuda" if torch.cuda.is_available() else "cpu"),
