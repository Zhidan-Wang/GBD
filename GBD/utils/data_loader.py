...
class Block:
    def __init__(self, mat, u_batch_size = 1000, i_batch_size = 1000):
        self.mat = mat
    ...
    def get_batch(self, batch_user, batch_item):
        ...
        index = torch.tensor(np.where(index_row * index_col)[0])
